define([], function() {
  ...
  class Text extends Fragment {
    ...
    copy(other) {
      super.copy(other)
      this.text = other.text.map(f => f.clone())
    }
  }
  ...
  class FragmentMacro extends Text {
    ...
    copy(other) {
      super.copy(other)
      this.key = other.key.map(f => f.clone())
      this.args = other.args.map(a => a.map(f => f.clone()))
    }
  }
  ...
  class Block extends Node {
    ...
    copy(other) {
      super.copy(other)
      this.children = other.children.map(f => f.clone())
    }
  }
  ...
  class ItemBlock extends Block {
    ...
    copy(other) {
      super.copy(other)
      this.items = other.items.map(f => f.clone())
    }
  }
  ...
  class Heading extends TextBlock {
    ...
    copy(other) {
      super.copy(other)
      this.level = other.level.map(f => f.clone())
    }
  }
